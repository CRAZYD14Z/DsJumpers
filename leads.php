...
<style>
        ...
        .status-nuevo { border-left: 5px solid #0d6efd !important; }
        .status-completado { border-left: 5px solid #198754 !important; }
        .status-pendiente { border-left: 5px solid #ffc107 !important; }
        .status-cancelado { border-left: 5px solid #dc3545 !important; }
...
function renderTable(data) {
    ...
    function getBadgeColor(status) {
        ...
        if (s.includes('nuevo')) return 'text-bg-primary';
        if (s.includes('completado')) return 'text-bg-success';
        if (s.includes('pendiente')) return 'text-bg-warning';
        if (s.includes('cancelado')) return 'text-bg-danger';
