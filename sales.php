...
*/
        ...
        $.each(data, function(i, item) {
            ...
            rows += `
                <tr class="${statusClass} clickable-row" data-id="${item.id}" style="cursor: pointer;">
                    ...
                    <td>
                        <div class="fw-bold text-dark">${item.NombreCliente} ${item.ApellidosCliente}</div>
                    ...
                    <td>
                        ...
                        <div class="small text-secondary">${item.Direccion}</div>
                    </td>
    ...
    $('#leadsData').on('click', '.clickable-row', function() {
        ...
        if (leadId) {
            ...
            window.location.href = `sale.php?IdSale=${leadId}`;
        }
    });    
